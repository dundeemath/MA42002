...
-   how do features of patterns that form (e.g. pattern wavelength, speed of aggregation) depend on individual cell properties?
...
Substituting the above perturbations into @eq-chemotaxis1d, we neglect higher order terms and retain only linear terms. This is largely straightforward, but we provide some detail for the linearisation of the chemotactic term i.e.
