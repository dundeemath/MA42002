...
\begin{center}
\begin{figure}
\includegraphics[width=0.99\textwidth]{phase_plane} 
\caption{Schematic diagram showing where the different types of fixed points lie in relation to {\rm det}A and {\rm tr}A, where A is the Jacobian matrix of system (44)}  
\end{figure}
\end{center} 