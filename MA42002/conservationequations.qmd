...
A substrate $S$ reacts, in a {\em reversible reaction}, with an enzyme $E$ to form a **complex** $SE$ or $C$, which in turn is converted into a product $P$. This may be described as follows:
