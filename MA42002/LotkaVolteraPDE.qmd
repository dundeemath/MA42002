...
We make  travelling wave *ansatz*
$$
\begin{aligned}
...
\end{aligned}
$$
in @eq-pp_eq_2 and consider the boundary conditions
$$
 \begin{aligned}
...
The system @eq-pp_eq_2 transforms to 
$$
\begin{aligned}
...
Upon makibg the assumption that the prey moves much more slowly than the predator species, i.e. 
$$
D= D_u/D_n \ll 1
$$
...
It can be shown that  the local min and max of $p(\lambda)$ are independent of $a$. 
...
p= lam**3-lam**2*(v-b/v)-lam*b-1/v*a*b*(1-b)
...
$$
\begin{aligned}
u(x,t) \to 1 \; \text{ as } x \to - \infty,  \quad &
 u(x,t) \to b \; \text{ as } x \to +\infty,  \\
n(x,t) \to 0 \;  \text{ as } x \to - \infty ,  \quad &
n(x,t) \to 1-b \; \text{ as } x \to +\infty.
\end{aligned}
$$