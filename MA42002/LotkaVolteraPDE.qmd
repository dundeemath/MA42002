...
for $a \in (0, a^\ast)$ we obtain $2$ real negative eigenvalues and $1$ positive real eigenvalue and $(b, 1-b, 0)$ is a saddle with $2$-dim stable manifold and $1$-dim unstable manifold
