...
In Figure @fig-schnack_ddi_pde we plot numerical solutions of @eq-schnackenbergeqns with no flux boundary conditions. 
...
## Exercise
Demonstrate that the derived results are consistent with th numerical solutions. Some predictions to test:
