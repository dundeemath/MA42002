...
%The critical value of $d=d_c$ at which the  bifurcation to instability occurs is defined by  $h_{min} =0$, i.e. such value of $d$ at which $h(k^2)=0$ has a double root. 
